...
- A curated model catalog of 42 flagship models with live pricing, brand filters, capability filters, search, and pagination. The gateway enforces the same list on its API, so /v1/models and chat requests serve exactly what the catalog shows.
